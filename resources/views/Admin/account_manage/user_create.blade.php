                ...
                <div class="card shadow mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <img id="avatar_preview" class="img-account-profile rounded-circle mb-2" 
                            src="{{ asset('storage/images/user/profile.png') }}"
                            alt="demo" width="200" height="200"><br>
                        <span id="image_status">{{ old('avatar') ? 'Ảnh đã được chọn' : 'Chưa có hình' }}</span>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-success">Thêm người dùng mới</button>
                    </div>
                </div>
            </div>
        </div>
