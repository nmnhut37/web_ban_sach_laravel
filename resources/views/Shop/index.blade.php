                ...
                <div class="card h-100" style="max-width: 180px;">
                    ...
                    <div class="card-footer text-center" style="background-color: #fff; border-top: 0px solid #ddd;">
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <input type="text" id="quantity_{{ $product->id }}" class="form-control mx-1" value="1" style="width: 60px; text-align: center;">
                            <button class="btn btn-outline-secondary increase" type="button">+</button>
                        </div>
                        <a href="javascript:void(0)" class="btn btn-primary addToCart mt-2" data-product-id="{{ $product->id }}">Thêm vào giỏ</a>
                    </div>
                </div>
            </div>
        @endforeach
